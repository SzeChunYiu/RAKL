...
The learner-conditioned extension is evaluated only after a cheap controlled exposure study shows that the proposed mastery coordinates are measurable. It explicitly separates existing Paper III static structural curation from a new adaptive treatment. Let the provisional learner state for registered structure $S$ be
\[
...
\item static RAKL structural curation;
\item adaptive learner-conditioned RAKL;
...
\operatorname{CTC}_{\mathrm{static\ RAKL}}-
\operatorname{CTC}_{\mathrm{adaptive\ RAKL}},
\]
...
\item adaptive RAKL does not beat static RAKL on the preregistered fresh structural-OOD estimand;
