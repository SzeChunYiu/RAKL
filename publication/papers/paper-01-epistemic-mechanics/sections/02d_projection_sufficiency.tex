...
\begin{tabular}{lccc}
\toprule
State projection & Identifiable accuracy upper bound & Unavoidable error lower bound & Zero-error legitimate-update recall upper bound\\
\midrule
