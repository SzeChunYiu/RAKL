...
Orion v3 merge incident & v3 was merged at operator request before CI cleanup; a later PR repaired CI and a benchmark float assertion & deployment occurred before assurance closure & deployment and method authority need separate states plus explicit operator-override records \\
\bottomrule
\end{tabularx}
