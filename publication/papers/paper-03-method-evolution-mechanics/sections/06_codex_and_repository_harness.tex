...
The same principle applies to mathematical applications. \texttt{RAKL\_math} remains the application-state repository; reusable framework mutations belong in \texttt{Orion}. Application evidence may motivate a framework issue but cannot write itself directly into framework authority.
