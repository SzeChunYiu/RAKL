\section{An evidence-triggered roadmap from Orion 3.0 to later challengers}
\label{sec:roadmap}
...
\[
\mathrm{Orion}_{3.0}\rightarrow \mathrm{Orion}_{3.1}\rightarrow \mathrm{Orion}_{3.2}\rightarrow\cdots
\]
