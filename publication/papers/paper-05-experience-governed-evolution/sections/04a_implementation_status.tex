...
Episode storage admission & deployed, internally hardened & \texttt{PROPOSAL\_SHADOW\_STORED} retention is distinct from \texttt{CANONICAL\_INVENTORY\_ADMITTED}; shadow history cannot satisfy a protected canonical consumer by filename or path convention \\
...
Matched RESET/LEARNING experience benchmark & executed scoped negative & v1.2 native job 3476548 produced 12/12 schema-valid records with correct chronology but zero registered successes in both arms under Qwen2.5-0.5B-Instruct; no transfer-success lift or global capability claim is licensed \\
...
Four-arm causal-attribution objects and scripts & integrated, preregistered; confirmatory study unexecuted & \texttt{MODEL\_ONLY}, RESET, SHAM and LEARNING comparisons can be run under a frozen packet; no four-arm causal performance result is reported \\
