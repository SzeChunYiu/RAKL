...
\[
\text{conjecture}\xrightarrow{\text{search}}\text{candidate},\qquad
\text{candidate}\xrightarrow{\text{proof}}\text{theorem},\qquad
...
The public code, benchmark and manuscript source are maintained at \url{https://github.com/SzeChunYiu/RAKL}. The canonical publication-series-v2 package is \path{publication/papers/paper-05-verified-discovery-in-mathematics/}; historical mathematical-assurance artifacts may retain the legacy Paper IV / \path{paper4} naming and remain immutable evidence identities. Language models were used for literature search, drafting and implementation assistance; they are not authors or independent reviewers. No model-generated judgement is represented as external human review.
