...
rows=[json.loads(l) for l in open(HERE.parent/"data"/"raw_results.jsonl") if l.strip()]
...
fig.tight_layout()
fig.savefig(HERE.parent/"llm_comparator.pdf",bbox_inches="tight")
fig.savefig(HERE.parent/"llm_comparator.png",bbox_inches="tight",dpi=200)
