...
&\begin{cases}
\mathrm{LICENSED}, &
  \parbox[t]{0.62\linewidth}{all load-bearing obligations are satisfied},\\[0.25em]
\mathrm{REJECTED}, &
  \parbox[t]{0.62\linewidth}{at least one load-bearing obligation is demonstrably violated},\\[0.25em]
\mathrm{CANNOT\_CHECK}, &
  \parbox[t]{0.62\linewidth}{otherwise, if at least one load-bearing obligation is unresolved}.
\end{cases}
\end{aligned}
\]
