...
The transfer decision is deliberately non-compensatory. Write
$\operatorname{Transfer}(A\to B;q)$ for the directional decision under QoI $q$. Then:
\begin{itemize}
