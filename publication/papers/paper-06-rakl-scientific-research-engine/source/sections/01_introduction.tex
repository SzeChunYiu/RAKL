...
\caption{Evidence maturity of the engine. \textbf{Executed:} the mechanics and their known-answer/hostile-world contracts, the immutable authority projection and the typed router (all proposal-only). \textbf{Same-context only:} interface self-repair (development-time), which is useful signal but not independent review or a superiority result. \textbf{Pending/blocked:} matched-workflow superiority, fresh-assurance self-evolution, a real quant-finance result, a fair external-LLM comparator and independent external review. The master blocker is a model-capability floor; no empirical-superiority claim is made in this paper.}
