% Standalone Orion capstone diagram (Paper VI, Figure: four coupled loops + authority firewall).
...
\node[loopout] (ot4) at (10.2,-3*\ry)  {Better Orion\\{\scriptsize assured challenger $M'$}};
...
% ---- fourth loop / governed recursion: better Orion reopens loops 1-3 ----
...
\node[lbl, text=oigreen!45!black, rotate=90, fill=white, inner sep=1pt] at (-2.55,-4.2)
      {governed recursion: better Orion reopens loops 1--3 (proposal-only)};
...
\node[anchor=north west, font=\scriptsize, text width=150mm, align=left, black!70]
      ...
      {\textbf{One firewall, four loops.} Persistence, retrieval, workspace occupancy, reflection and
       ...
       Only an evidence- and governance-bearing certificate ($V$ / fresh assurance / protected Self-Orion gate)
