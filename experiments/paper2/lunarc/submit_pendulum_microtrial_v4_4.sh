...
REPO="$ROOT/repo"
CONTRACT_REL=research/paper2_microtrial_v4_4/BATCH_CONTRACT_V4_4.json
CONTRACT="$REPO/$CONTRACT_REL"
PACKET="$REPO/research/paper2_microtrial_v4_4/EXECUTION_PACKET_V4_4_20260811.json"
POLICY="$REPO/research/paper2_microtrial_v4_4/OUTPUT_NORMALIZATION_CONTRACT_V4_4.json"
RECEIPT_ROOT="$ROOT/receipts/v4_4"
LOG_ROOT="$ROOT/logs/v4_4"
RUN_ROOT="$ROOT/runs/v4_4"
PYTHON="$ROOT/assets/paper2-cpu-v3-2/runtime/python/bin/python3.11"
SUBMISSION_SCHEMA="$REPO/schemas/paper2-pendulum-submission-receipt-v4-4.schema.json"
...
contract=json.loads(contract_path.read_text(encoding="utf-8"))
receipt={
  "schema_version":"paper2-pendulum-submission-receipt-v4.4",
  "created_at_utc":datetime.datetime.now(datetime.timezone.utc).isoformat().replace("+00:00","Z"),
  "verdict":"SUBMITTED_NONCONFIRMATORY_V4_4_TASK_SEED_BATCH",
  ...
  "claim_boundary":"Submission receipt only for a fresh V4.4 batch; harvest is required and V4/V4.1 negatives remain frozen; V4.4 harvest required."
}
