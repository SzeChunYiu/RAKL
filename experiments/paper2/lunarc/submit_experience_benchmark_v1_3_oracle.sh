#!/usr/bin/env bash
# Submit Paper-II ExperienceBenchmark v1.3 Phase-1 ORACLE @ 0.5B on LUNARC FS9.
# Bound to frozen protocol_subject_hash from research/paper2_experience_benchmark_v1_3/.
# learning_loop_mode=root_cause_v1; diagnostic_arm=ORACLE_PROCEDURE_UPPER_BOUND.
# Does NOT submit 1.5B, staircase arms, Paper-III (#217), or reopen #138.
set -euo pipefail
...
REPO="$ROOT/repo"
PACKET_REL=research/paper2_experience_benchmark_v1_3
PROTOCOL_SUBJECT_HASH=ed116353230dc526fa45657d1a81afab26a460fe3b8411480a0f84bb1f711672
CONTRACT_REL=research/paper2_experience_benchmark_v1_3/BATCH_CONTRACT_V1_3_ORACLE.json
...
LOG_ROOT="$ROOT/logs/experience_v1_3_oracle"
RUN_ROOT="$ROOT/runs/experience_v1_3_oracle"
SBATCH_REL=experiments/paper2/lunarc/run_experience_benchmark_v1_3_oracle.sbatch
...
witness=json.loads((repo/"research/paper2_experience_benchmark_v1_3/DIFFERENCE_WITNESS_V1_3.json").read_text(encoding="utf-8"))
if witness.get("explicitly_not_scale_only") is not True: raise SystemExit("DifferenceWitness must not be scale-only")
...
receipt={
  ...
  "verdict":"SUBMITTED_EXPERIENCE_BENCHMARK_V1_3_ORACLE",
  ...
  "experience_benchmark_1_5B_submitted":False,
  "reopen_issue_138":False,
  "reinterpret_parent_job_3476548_as_lift":False,
  "model_execution_observed_by_submitter":False,
  "claim_boundary":"Submission receipt only for #247 Phase-1 0.5B ORACLE. Not manuscript authority. Not experience-learning efficacy.",
}
