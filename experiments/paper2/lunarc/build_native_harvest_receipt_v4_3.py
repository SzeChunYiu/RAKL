#!/usr/bin/env python3
"""Build a fail-closed V4.3 native harvest receipt from exact LUNARC evidence."""
...
def build(args: argparse.Namespace) -> int:
    ...
    receipt = {
        "schema_version": "paper2-pendulum-native-harvest-receipt-v4.3",
        "created_at_utc": datetime.datetime.now(datetime.timezone.utc).isoformat().replace("+00:00", "Z"),
        "slurm_job_id": args.job_id,
        "verdict": "HARVEST_V4_3_TASK_SEED_PASS_NONCONFIRMATORY" if success else "HARVEST_V4_3_CANNOT_CHECK",
        "failures": failures,
        "scheduler_evidence": {
            "path": str(args.sacct),
        ...
        "claim_boundary": (
            "At most one fresh non-confirmatory V4.3 task/seed unit. A pass is receipt-chain "
