#!/usr/bin/env bash
# Submit Paper-II ExperienceBenchmark v1.3_3 Phase-1 ORACLE @ 7B on LUNARC FS9.
# Bound to frozen protocol_subject_hash from research/paper2_experience_benchmark_v1_3_3/.
# learning_loop_mode=root_cause_v1; diagnostic_arm=ORACLE_PROCEDURE_UPPER_BOUND.
# Parent is floored v1.3_2 3B ORACLE (3476778); 3476756 remains FLOOR_1_5B; 3476742 remains INSTRUMENT_DEFECT.
...
REPO="$ROOT/repo"
PACKET_REL=research/paper2_experience_benchmark_v1_3_3
PROTOCOL_SUBJECT_HASH=dc7bff2e6fae3b54d0af87d116234081d4fd516645d735552fdc0d1b4f2141d6
CONTRACT_REL=research/paper2_experience_benchmark_v1_3_3/BATCH_CONTRACT_V1_3_3_ORACLE.json
...
RECEIPT_ROOT="$ROOT/receipts/experience_v1_3_3_oracle"
LOG_ROOT="$ROOT/logs/experience_v1_3_3_oracle"
RUN_ROOT="$ROOT/runs/experience_v1_3_3_oracle"
SBATCH_REL=experiments/paper2/lunarc/run_experience_benchmark_v1_3_3_oracle.sbatch
...
witness=json.loads((repo/"research/paper2_experience_benchmark_v1_3_3/DIFFERENCE_WITNESS_V1_3_3.json").read_text(encoding="utf-8"))
...
if witness.get("scale_change_from_floored_3B_oracle") is not True: raise SystemExit("must record scale change from floored 3B ORACLE")
...
if witness.get("parent_scientific_verdict") != "MODEL_CAPABILITY_FLOOR_3B": raise SystemExit("parent must be floored 3B ORACLE")
...
receipt={
  ...
  "verdict":"SUBMITTED_EXPERIENCE_BENCHMARK_V1_3_3_ORACLE",
  ...
  "claim_boundary":"Submission receipt only for #372 Phase-1 7B ORACLE after floored 3B. Not manuscript authority. Not experience-learning efficacy.",
}
