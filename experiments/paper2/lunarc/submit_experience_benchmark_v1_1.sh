...
# Bound to frozen protocol_subject_hash from research/paper2_experience_benchmark_v1_1/.
...
REPO="$ROOT/repo"
PACKET_REL=research/paper2_experience_benchmark_v1_1
PROTOCOL_SUBJECT_HASH=c7b1a04007e237f54acd2d0efd1c90870ad20718dec9392216ce49b169f7bedb
CONTRACT_REL=research/paper2_experience_benchmark_v1_1/BATCH_CONTRACT_V1_1.json
...
RECEIPT_ROOT="$ROOT/receipts/experience_v1_1"
LOG_ROOT="$ROOT/logs/experience_v1_1"
RUN_ROOT="$ROOT/runs/experience_v1_1"
SBATCH_REL=experiments/paper2/lunarc/run_experience_benchmark_v1_1.sbatch
...
receipt={
  ...
  "issue":138,
  "section":"B2",
  "verdict":"SUBMITTED_EXPERIENCE_BENCHMARK_V1_1",
