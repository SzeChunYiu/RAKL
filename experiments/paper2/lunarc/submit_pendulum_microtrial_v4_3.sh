...
REPO="$ROOT/repo"
CONTRACT_REL=research/paper2_microtrial_v4_3/BATCH_CONTRACT_V4_3.json
CONTRACT="$REPO/$CONTRACT_REL"
PACKET="$REPO/research/paper2_microtrial_v4_3/EXECUTION_PACKET_V4_3_20260811.json"
...
contract=json.loads(contract_path.read_text(encoding="utf-8"))
receipt={
  "schema_version":"paper2-pendulum-submission-receipt-v4.3",
  "created_at_utc":datetime.datetime.now(datetime.timezone.utc).isoformat().replace("+00:00","Z"),
  "verdict":"SUBMITTED_NONCONFIRMATORY_V4_3_TASK_SEED_BATCH",
  ...
  "claim_boundary":"Submission receipt only for a fresh V4.3 batch; harvest is required and V4/V4.1 negatives remain frozen; V4.3 harvest required."
}
