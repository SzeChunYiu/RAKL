...
REPO="$ROOT/repo"
CONTRACT_REL=research/paper2_microtrial_v4_1/BATCH_CONTRACT_V4_1.json
CONTRACT="$REPO/$CONTRACT_REL"
PACKET="$REPO/research/paper2_microtrial_v4_1/EXECUTION_PACKET_V4_1_20260811.json"
POLICY="$REPO/research/paper2_microtrial_v4_1/OUTPUT_NORMALIZATION_CONTRACT_V4_1.json"
RECEIPT_ROOT="$ROOT/receipts/v4_1"
LOG_ROOT="$ROOT/logs/v4_1"
RUN_ROOT="$ROOT/runs/v4_1"
PYTHON="$ROOT/assets/paper2-cpu-v3-2/runtime/python/bin/python3.11"
SUBMISSION_SCHEMA="$REPO/schemas/paper2-pendulum-submission-receipt-v4-1.schema.json"
...
receipt={
  ...
  "claim_boundary":"Submission receipt only for a fresh V4.1 batch; harvest is required and V4 remains two parse-invalid nulls."
}
