...
# Bound to frozen protocol_subject_hash from research/paper2_experience_benchmark_v1/.
...
REPO="$ROOT/repo"
PACKET_REL=research/paper2_experience_benchmark_v1
PROTOCOL_SUBJECT_HASH=1248dd101ff2cda94f2dfd91f990350dc46a59d169b4db36f2e64a596bf30b56
CONTRACT_REL=research/paper2_experience_benchmark_v1/BATCH_CONTRACT_V1.json
...
RECEIPT_ROOT="$ROOT/receipts/experience_v1"
LOG_ROOT="$ROOT/logs/experience_v1"
RUN_ROOT="$ROOT/runs/experience_v1"
SBATCH_REL=experiments/paper2/lunarc/run_experience_benchmark_v1.sbatch
...
receipt={
  ...
  "issue":138,
  "section":"B2",
  "verdict":"SUBMITTED_EXPERIENCE_BENCHMARK_V1",
