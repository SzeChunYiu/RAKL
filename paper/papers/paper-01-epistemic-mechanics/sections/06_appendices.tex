...
Context-aligned projection reduces false-contradiction rate vs naive value comparison on synthetic known-answer corpus & \path{research/benefit_L0_fcr_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/core.py} context handling \\
Typed transition algebra reduces unsupported-composition rate vs untyped chaining on synthetic known-answer corpus & \path{research/benefit_L1_composition_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/bridge_composition.py} \\
Obstruction-retaining gluing reduces wrong-gluing rate vs pairwise-only compatibility on synthetic known-answer corpus (including mechanized parity family) & \path{research/benefit_L2_gluing_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/atlas_gluing.py} \\
Certificate-gated authority upgrading reduces authority-leak rate vs ungoverned upgrading on synthetic known-answer corpus & \path{research/benefit_L3_authority_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/evidence_binding_certificate.py} \\
Distil-and-navigate solves more multi-hop worlds than budgeted lexical raw reading at matched total budget (MEDIUM/LOOSE budgets only) & \path{research/benefit_L4_navigation_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/support_solver.py} \\
Flat-round saturation stopping retains non-inferior set-completeness while saving budget on synthetic known-answer streams & \path{research/benefit_L5_saturation_v1/results_v1/RESULTS.json} (PROMOTE) & \path{src/rakl/epistemic_saturation.py} \\
