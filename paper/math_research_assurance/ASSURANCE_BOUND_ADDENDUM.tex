...
For novelty, a distinct error event $E_{\mathrm{novel}}$ must be tracked. A promoted \texttt{NEW\_MATHEMATICS\_CANDIDATE} therefore has a broader research-level risk decomposition,
\[
\Pr(F_{\mathrm{research}})
\leq
\Pr(E_{\mathrm{spec}})
+\Pr(E_{\mathrm{trust}})
+\Pr(E_{\mathrm{novel}})
