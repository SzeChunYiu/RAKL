...
files only, requires the fast-tokenizer pair probe, and rejects any model or
shared-runtime content change. At this contract stage neither job has been
submitted and no descriptor exists.
