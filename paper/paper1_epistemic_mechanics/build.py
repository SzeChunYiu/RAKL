...
def build(subject_sha:str,software_tests:int)->Path:
    ...
    source=source.replace(r"\input{sections/07_bibliography}",r"\input{figures/figure_appendix}"+"\n"+r"\input{sections/07_bibliography}",1)
    temp=ROOT/"release_main.tex";temp.write_text(source,encoding="utf-8")
