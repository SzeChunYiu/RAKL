...
def test_issue_324_cannot_execute_confirmatory_alr() -> None:
    ...
    assert receipt["terminal_status"] == "CANNOT_EXECUTE_CONFIRMATORY_ALR"
...
def test_issue_326_power_limited_retain_v21() -> None:
    ...
    assert zero["window_status"] == "ZERO_REAL_LABELS_WINDOW_OPEN"
    assert zero["demoted_ai_operator_inventory"]["counts_as_first_real_independent_label"] is False
