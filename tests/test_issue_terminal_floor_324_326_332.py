...
def test_issue_326_power_limited_retain_v21() -> None:
    ...
    assert zero["state"] == "ZERO_LABELS_OBSERVED"
    assert zero["issue_217_scan"]["first_real_independent_label_present"] is False
    assert terminal["acceptance_assessment"]["independent_human_labels_present"] is False
