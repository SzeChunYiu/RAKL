...
def evaluate_method_assimilation(
    ...
    This function deliberately stops before activation. It separates clean shadow
    eligibility, semantic equivalence, incompatible-but-useful local views,
    blocking failures, explicit rejection, and missing evidence.
    """
    ...
    return AssimilationReport(
        ...
        (
            "contract_complete",
            "authority_envelope_clean",
            "external_evidence_checks_pass",
            "not_equivalent_to_incumbent",
            "compatible_for_shadow_comparison",
        ),
    )
