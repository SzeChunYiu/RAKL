# V4.4 leak-free prompt draft (NOT EXECUTABLE)

Status: **DRAFT staging** — NOT EXECUTABLE as a batch/packet. Executable successor after positive-control PASS: `research/paper2_microtrial_v4_4/`.
