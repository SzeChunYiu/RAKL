# ORACLE capability-gate v2.0 — task/gate revisit (#379)
...
| File | Role |
|------|------|
| `FLOOR7B_STRATUM_DIAGNOSIS_RECEIPT.json` | Why 7B got 1/3 (stratum × failure signatures) |
| `PROTOCOL_FREEZE_PACKET.json` | Unit of analysis, thresholds, strata, predicted discriminator |
...
- 14B/32B ORACLE
- Phase-0 / confirmatory learning jobs from this freeze
