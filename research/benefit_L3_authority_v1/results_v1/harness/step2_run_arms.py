...
the frozen corpus hash changed since freeze, or if the module pins drifted.
"""
...
def main() -> int:
    ...
    for arm in ("A", "B"):
        ...
        telemetry = ProcessTelemetry(
            invocation_id=f"benefit-l3-authority-v1:arm-{arm}",
            process_surface="authority_promotion",
        ...
        print(f"arm {arm}: upgraded={arm_out['n_declared_upgrade']} "
