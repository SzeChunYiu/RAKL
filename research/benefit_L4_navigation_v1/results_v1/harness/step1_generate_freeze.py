...
ARM_INPUT_FIELDS = (
    "world_id", "budget_class", "budget_units", "target", "sources", "surface_text",
)
...
def main() -> int:
    ...
    audit_sample = {
        "note": ("auditor-facing sample: ONLY the rendered claim description and the "
                 "gold label; no machine fields, no class/S* fields, no arm outputs exist yet"),
    ...
    telemetry = ProcessTelemetry(
        invocation_id="benefit-l4-navigation-v1:corpus-freeze",
        ...
        residual_after=("L4-benefit-unmeasured",),
        retained_novelty=(),
