"""Shared identity/receipt plumbing for the BENEFIT-L4-NAVIGATION-V1 execution run.
...
Module pins (PROTOCOL.json arms.B_distil_and_navigate.module_pins) are
...
FROZEN_EVALUATOR_SHA256 = "2dd3726fc99354c1fe70704843ac628946cb00eeb15955747fcb8494eebe418d"
MODULE_PINS = {
    "src/rakl/support_solver.py": "180548b10a4465194c0aefd458a55e78dd23e00a9d8a7e4eb64ca6bd4fd374c6",
}
...
def build_run_epoch():
    ...
    return build_evaluation_epoch(
        ...
        observatory_instrumentation_hash="benefit-l4-navigation-v1-rshea-binding-v1",
    )
