"""Shared identity/receipt plumbing for the BENEFIT-L5-SATURATION-V1 execution run.
...
Module pins (PROTOCOL.json arms.B_saturation_stopping.module_pins) are
...
FROZEN_EVALUATOR_SHA256 = "b3e739d8b8a02121d11568f2de718bea6cdacbbbb888d8f0e074db49b83fec7f"
MODULE_PINS = {
    "src/rakl/epistemic_saturation.py": "aac384c41999c44facc526a9a32a306ac71eeab9d008fe5248500fcddb423546",
}
...
def build_run_epoch():
    ...
    return build_evaluation_epoch(
        ...
        observatory_instrumentation_hash="benefit-l5-saturation-v1-rshea-binding-v1",
    )
